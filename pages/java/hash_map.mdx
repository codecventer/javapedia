...
```java filename="hash_map_get_or_default.java"
...
```java filename="hash_map_get_or_default_1.java"
...
```java filename="hash_map_put_absent.java"
...
```java filename="hash_map_merge.java"
...
```java filename="hash_map_merge_1.java"
if(productsByName.containsKey("E-Bike")) {
...
```java filename="hash_map_compute.java"
...
```java filename="hash_map_compute_1.java"
if(productsByName.containsKey("E-Bike")) {
    productsByName.get("E-Bike").addTagsOfOtherProduct(eBike2);
} else {
    productsByName.put("E-Bike", eBike2);
...
```java filename="hash_map_mutable.java"
...
```java filename="hash_map_mutable_1.java"
